...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      // ─────────────────────────────────────────── the picture on every share
      //
      // Both of these pointed at a LOVABLE BUILD PREVIEW until 8 Aug 2026:
      //
      //   https://pub-bb2e…r2.dev/…/id-preview-b316bebf--…lovable.app-…png
      //
      // Live and serving — so every share of this company on LinkedIn or
      // WhatsApp fetched its picture from a bucket Neuvto does not own, with
      // `id-preview` and `lovable.app` in the filename, and it would vanish
      // whenever that bucket was pruned. The same reason the deploy pipeline
      // moved off Lovable in the first place.
      //
      // Now served from our own origin, generated by
      // scripts/generate-social-card.py from the mark and the design tokens.
      //
      // ABSOLUTE, not a path. Open Graph consumers do not resolve relative
      // URLs — a leading-slash value is silently no image at all, and the only
      // way to see that is to share the link and look.
      { property: "og:image", content: "https://neuvto.com/social-card.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "neuvto. — The Workforce Operating System" },
      { name: "twitter:image", content: "https://neuvto.com/social-card.png" },
